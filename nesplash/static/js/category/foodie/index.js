...
const a = document.getElementsByClassName("foodie-a")[0];
const photos_id = document.getElementsByClassName("foodie-section-2-div");
const icons = document.getElementsByClassName("foodie-collect-icon");
...
class Foodie {
    ...
    display_foodie(results){
        ...
        for(var i=0;i<results.length;i++){
            ...
            div.classList.add("foodie-section-2-div");
            img.classList.add("foodie-section-2-img");
            s_img.classList.add("sec_2_imgfile");
            s_div.classList.add("sec_2_topDiv");
            link_div.classList.add("foodie-link-div");
            inside_a.classList.add("foodie-section-2-inside-a");
            outside_a.classList.add("foodie-section-2-outside-a");
            p.classList.add("foodie-section-2-p");
            icon.classList.add("foodie-collect-icon");
            download.classList.add("foodie-sec_2_download");
    ...
    fetchData(page){
        ...
        const url = `http://localhost:5000/foodie/api/photos?page=${page}`;
        post_flag = true;
        fetch(url)
        .then( async (response)=>{
