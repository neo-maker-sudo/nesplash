const section_2 = document.querySelector(".architecture-section-2");
const a = document.getElementsByClassName("architecture-a")[0];
const photos_id = document.getElementsByClassName("architecture-section-2-div");
const icons = document.getElementsByClassName("architecture-collect-icon");
...
class Architecture {
    ...
    display_architecture(results){
        ...
        for(var i=0;i<results.length;i++){
            ...
            div.classList.add("architecture-section-2-div");
            img.classList.add("architecture-section-2-img");
            s_img.classList.add("sec_2_imgfile");
            s_div.classList.add("sec_2_topDiv");
            link_div.classList.add("architecture-link-div");
            inside_a.classList.add("architecture-section-2-inside-a");
            outside_a.classList.add("architecture-section-2-outside-a");
            p.classList.add("architecture-section-2-p");
            icon.classList.add("architecture-collect-icon");
            download.classList.add("architecture-sec_2_download");
    ...
    fetchData(page){
        ...
        .then((result)=>{
            this.display_architecture(result.message)
            window.onscroll = () => {
