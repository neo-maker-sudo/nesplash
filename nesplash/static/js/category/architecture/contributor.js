...
const a = document.getElementsByClassName("architecture-a")[2]
...
class Architecture {
    ...
    display_architecture(results){
        ...
        for(var i=0;i<results.length;i++){
            ...
            div.classList.add("architecture-section-2-contributorDiv");
            img.classList.add("sec_2_contributorImgfile");
            p.classList.add("architecture-section-2-contributorp");
            link_div.classList.add("architecture-section-2-contributor-linkDiv")
            inside_a.classList.add("architecture-section-2-contributor-inside-a");
            outside_a.classList.add("architecture-section-2-contributor-outside-a")
