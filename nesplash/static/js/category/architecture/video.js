...
const a = document.getElementsByClassName("architecture-a")[1]
...
class Architecture {
    ...
    display_architecture(results){
        ...
        for(var i=0;i<results.length;i++){
            ...
            div.classList.add("architecture-section-2-videoDiv");
            source.classList.add("architecture-section-2-img");
            s_img.classList.add("sec_2_imgfile");
            s_div.classList.add("sec_2_videoTopDiv");
            a.classList.add("architecture-section-2-video_a");
            video.classList.add("architecture-video");
