...
const a = document.getElementsByClassName("people-a")[1];
...
class People {
    ...
    display_people(results){
        ...
        for(var i=0;i<results.length;i++){
            ...
            div.classList.add("people-section-2-videoDiv");
            source.classList.add("people-section-2-img");
            s_img.classList.add("sec_2_imgfile");
            s_div.classList.add("sec_2_videoTopDiv");
            a.classList.add("people-section-2-video_a");
            video.classList.add("people-video");
