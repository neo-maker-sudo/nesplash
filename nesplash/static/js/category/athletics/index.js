...
const a = document.getElementsByClassName("athletics-a")[0];
const photos_id = document.getElementsByClassName("athletics-section-2-div");
const icons = document.getElementsByClassName("athletics-collect-icon");
...
class Athletics {
    ...
    display_athletics(results){
        ...
        for(var i=0;i<results.length;i++){
            ...
            div.classList.add("athletics-section-2-div");
            img.classList.add("athletics-section-2-img");
            s_img.classList.add("sec_2_imgfile");
            s_div.classList.add("sec_2_topDiv");
            link_div.classList.add("athletics-link-div");
            inside_a.classList.add("athletics-section-2-inside-a");
            outside_a.classList.add("athletics-section-2-outside-a");
            p.classList.add("athletics-section-2-p");
            icon.classList.add("athletics-collect-icon");
            download.classList.add("athletics-sec_2_download");
