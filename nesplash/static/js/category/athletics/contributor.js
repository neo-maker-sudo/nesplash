...
const a = document.getElementsByClassName("athletics-a")[2]
...
class Athletics {
    ...
    display_athletics(results){
        ...
        for(var i=0;i<results.length;i++){
            ...
            div.classList.add("athletics-section-2-contributorDiv");
            img.classList.add("sec_2_contributorImgfile");
            p.classList.add("athletics-section-2-contributorp");
            link_div.classList.add("athletics-section-2-contributor-linkDiv")
            inside_a.classList.add("athletics-section-2-contributor-inside-a");
            outside_a.classList.add("athletics-section-2-contributor-outside-a")
    ...
    fetchData(page){
        ...
        const url = `http://localhost:5000/athletics/api/contributor?page=${page}`;
        post_flag = true;
        fetch(url)
        .then( async (response)=>{
