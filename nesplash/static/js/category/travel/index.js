const section_2 = document.querySelector(".travel-section-2");
const a = document.getElementsByClassName("travel-a")[0];
const photos_id = document.getElementsByClassName("travel-section-2-div");
const icons = document.getElementsByClassName("travel-collect-icon");
...
class Travel {
    ...
    display_travel(results){
        ...
        for(var i=0;i<results.length;i++){
            ...
            div.classList.add("travel-section-2-div");
            img.classList.add("travel-section-2-img");
            s_img.classList.add("sec_2_imgfile");
            s_div.classList.add("sec_2_topDiv");
            link_div.classList.add("travel-link-div");
            inside_a.classList.add("travel-section-2-inside-a");
            outside_a.classList.add("travel-section-2-outside-a");
            p.classList.add("travel-section-2-p");
            icon.classList.add("travel-collect-icon");
            download.classList.add("travel-sec_2_download");
    ...
    fetchData(page){
        ...
        .then((result)=>{
            this.display_travel(result.message)
            window.onscroll = () => {
