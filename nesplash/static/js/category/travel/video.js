...
const a = document.getElementsByClassName("travel-a")[1]
...
class Travel {
    ...
    display_travel(results){
        ...
        for(var i=0;i<results.length;i++){
            ...
            div.classList.add("travel-section-2-videoDiv");
            source.classList.add("travel-section-2-img");
            s_img.classList.add("sec_2_imgfile");
            s_div.classList.add("sec_2_videoTopDiv");
            a.classList.add("travel-section-2-video_a");
            video.classList.add("travel-video");
